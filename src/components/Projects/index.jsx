...
const Projects = () => {
  return (
    <div className="min-h-screen flex flex-col gap-20 items-start justify-center mb-30">
      <main className="flex flex-col gap-15 justify-center items-start mt-30 mb-0 mx-7 md:mt-30 md:mb-0 md:mx-30">
            <motion.div
              variants={{
                hidden: {
                  opacity: 0,
              ...
              className="heading"
            >
              <div className='w-7/12 flex flex-col gap-5 justify-center items-start'>
